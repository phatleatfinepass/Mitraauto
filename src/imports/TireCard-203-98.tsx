import svgPaths from "./svg-omrvu334su";
...
function Text() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border relative size-[12px]">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[12.5px] left-0 not-italic text-[8.333px] text-nowrap text-white top-[0.42px] tracking-[0.0977px] whitespace-pre">EU</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="relative rounded-[10px] shrink-0 size-[20px]" data-name="Container">
...
function Text1() {
  return (
    <div className="h-[16px] relative shrink-0 w-[37.57px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16px] relative w-[37.57px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[12px] text-[rgba(20,71,230,0.7)] text-nowrap top-px tracking-[0.6px] uppercase whitespace-pre">Label</p>
      </div>
    </div>
  );
}
...
function Fuel() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[63.5px] items-center relative shrink-0 w-[21.016px]" data-name="Fuel">
      <Icon />
      <Value />
      <Label1 />
    </div>
...
function Wet() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] h-[63.5px] items-center relative shrink-0 w-[21.016px]" data-name="Wet">
      <Icon1 />
      <Value1 />
      <Label2 />
    </div>
...
function Text2() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border relative size-[12px]">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[12.5px] left-[6px] not-italic text-[8.333px] text-center text-white top-0 tracking-[0.0977px] translate-x-[-50%] w-[12px]">€</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[16px] relative shrink-0 w-[37.57px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[16px] relative w-[37.57px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[12px] text-[rgba(202,53,0,0.7)] text-nowrap top-px tracking-[0.6px] uppercase whitespace-pre">PRICE</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[94px]" data-name="Container">
      <Container6 />
      <Text3 />
    </div>
  );
...
function Text4() {
  return (
    <div className="basis-0 grow h-[32px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[32px] left-0 not-italic text-[#101828] text-[20px] top-0 tracking-[-0.5297px] w-[89px]">9999.99</p>
    </div>
  );
}
