import svgPaths from "./svg-ow3og02qol";
...
function ImageWithFallback() {
  return (
    <div className="bg-white h-[157px] relative rounded-[16px] shrink-0 w-full" data-name="ImageWithFallback">
      <div className="h-[157px] overflow-clip relative rounded-[inherit] w-full">
        <div className="absolute left-1/2 size-[286px] top-[14px] translate-x-[-50%]" data-name="Image">
...
function Container3() {
  return (
    <div className="basis-0 grow h-[88px] min-h-px min-w-px relative rounded-[16px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#bedbff] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[16px] h-[88px] items-start p-[12px] relative w-full">
          <Container2 />
        </div>
      </div>
    </div>
...
function Container4() {
  return (
    <div className="h-[16px] relative shrink-0 w-[45px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[12px] text-[rgba(202,53,0,0.7)] text-nowrap top-0 tracking-[1.2px] uppercase whitespace-pre">Price</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-[96px]" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-[rgba(202,53,0,0.7)] text-nowrap tracking-[1.2px] uppercase whitespace-pre">€</p>
      <Container4 />
    </div>
  );
}
...
function Text() {
  return (
    <div className="basis-0 grow h-[32px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[32px] left-0 not-italic text-[#101828] text-[22px] top-0 tracking-[-0.5297px] w-[89px]">999.99</p>
    </div>
  );
}
