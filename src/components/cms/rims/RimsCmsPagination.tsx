  ...
  return (
    <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
        {t('rimsCmsPagination.showing', { start: startItem, end: endItem, total: totalCount })}
      </p>
      <div className="flex items-center gap-2">
        <button
          ...
          aria-label={t('rimsCmsPagination.firstPage')}
        >
          {t('rimsCmsPagination.first')}
        </button>
        <button
          type="button"
        ...
        <button
          ...
          aria-label={t('rimsCmsPagination.lastPage')}
        >
          {t('rimsCmsPagination.last')}
        </button>
      </div>
    </div>
  );
