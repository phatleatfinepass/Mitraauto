...
export const legalTranslations = {
  ...
  'legal.timeline.v8.cookieDescription': { fi: 'Evästekäytäntö, Microsoft Clarity ja analytiikkasuostumus', en: 'Cookie policy, Microsoft Clarity, and analytics consent release' },
  ...
  'legal.cookie.effective': { fi: 'Voimaantulopäivä', en: 'Effective Date' },
  'legal.cookie.lastUpdated': { fi: 'Viimeksi päivitetty', en: 'Last Updated' },
