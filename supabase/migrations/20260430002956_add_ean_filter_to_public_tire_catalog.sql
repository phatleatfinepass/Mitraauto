...
revoke all on function public.webshop_tire_matches_filters(public.webshop_items, text, text[], numeric, numeric, numeric, text, text, boolean, boolean, boolean, boolean, boolean) from public;
grant execute on function public.webshop_tire_matches_filters(public.webshop_items, text, text[], numeric, numeric, numeric, text, text, boolean, boolean, boolean, boolean, boolean) to anon, authenticated, service_role;

grant execute on function public.catalog_count_tires_v1(text, text[], numeric, numeric, numeric, text, text, boolean, boolean, boolean, boolean, boolean) to anon, authenticated;
