...
revoke all on function public.catalog_list_product_sitemap_rows_v1() from public;
grant execute on function public.catalog_list_product_sitemap_rows_v1() to anon, authenticated, service_role;
