    ...
    'bookings', coalesce((
      ...
      from (
        ...
        where (
          ...
          v_phone is not null and regexp_replace(coalesce(b.customer_phone, ''), '\s+', '', 'g') = v_phone
        ) or (
          array_length(v_plates, 1) is not null and upper(btrim(coalesce(b.license_plate, ''))) = any(v_plates)
        )
    ...
    'orders', coalesce((
      ...
      from (
        ...
        where (
          ...
          v_phone is not null and regexp_replace(coalesce(o.phone, o.cart_snapshot #>> '{customer,phone}', o.cart_snapshot #>> '{billing,phone}', ''), '\s+', '', 'g') = v_phone
        )
    ...
    'invoices', coalesce((
      ...
      from (
        ...
        where (
          ...
          v_phone is not null and regexp_replace(coalesce(i.customer_phone, ''), '\s+', '', 'g') = v_phone
        )
