    ...
    'pickup_schedule', coalesce((
      ...
      from (
        select jsonb_build_object(
          ...
          'fulfillment_status', coalesce(o.cart_snapshot #>> '{fulfillment_status}', o.status::text),
        ...
        where coalesce(o.cart_snapshot #>> '{fulfillment_status}', o.status::text) in ('ready_for_pickup', 'arrived', 'processing', 'ready')
          and (
            o.customer_id = c.id
            or (
